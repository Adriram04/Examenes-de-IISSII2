...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  const [togglePin, setTogglePin] = useState(null)
    ...
    return (
      ...
      >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }} >
          ...
          <Pressable onPress={() => { setTogglePin(item) }}>
  ...
  return (
    ...
    <ConfirmationModal
      isVisible={togglePin !== null}
      onCancel={() => setTogglePin(null)}
      onConfirm={() => togle(togglePin)}>
    </ConfirmationModal>
    </>
  )
}
